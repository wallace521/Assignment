...
// ====================================DELETE METHOD==========================================================================	
  ...
  case 'DELETE':
  	...
  	$favlistid=$_SERVER['favlistid'];
  	
	//$result = mysql_query("DELETE FROM comment WHERE commendid=cmid;") or die("Could not issue MySQL query");
	$retval = mysql_query( "DELETE FROM favlist WHERE favlistid=$favlistid" );
	if(! $retval )
	{
